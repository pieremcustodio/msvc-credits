...
public class CreditCardController {
     ...
     */
    @ApiOperation(value = "Check balance of a credit card", nickname = "checkBalance", notes = "Check balance of a credit card", response = CreditCardDto.class, tags={ "creditCards", })
    @ApiResponses(value = { 
    ...
    Mono<ResponseEntity<CreditCardDto>> checkBalance(@ApiParam(value = "ID of the credit card",required=true) @PathVariable("id") String id) {
     ...
     */
    @ApiOperation(value = "Create a new credit card", nickname = "createCreditCard", notes = "Create a new credit card", response = CreditCardDto.class, tags={ "creditCards", })
    @ApiResponses(value = { 
    ...
    Mono<ResponseEntity<CreditCardDto>> createCreditCard(@ApiParam(value = "" ,required=true )  @Valid @RequestBody CreditCardDto creditCardDto) {
     ...
     *         or Not found (status code 404)
     */
    @ApiOperation(value = "Delete a credit card", nickname = "deleteCreditCard", notes = "Delete a credit card", tags={ "creditCards", })
    @ApiResponses(value = { 
    ...
    Mono<ResponseEntity<Void>> deleteCreditCard(@ApiParam(value = "" ,required=true )  @Valid @RequestBody CreditCardDto creditCardDto) {
     ...
     */
    @ApiOperation(value = "Get all credit cards", nickname = "findAllCreditCards", notes = "Get all credit cards", response = CreditCardDto.class, responseContainer = "List", tags={ "creditCards", })
    @ApiResponses(value = { 
     ...
     */
    @ApiOperation(value = "Make a charge", nickname = "makeChargeCreditCard", notes = "Make a charge", response = CreditCardDto.class, tags={ "creditCards", })
    @ApiResponses(value = { 
    ...
    Mono<ResponseEntity<CreditCardDto>> makeChargeCreditCard(@ApiParam(value = "ID of the credit card",required=true) @PathVariable("id") String id,@ApiParam(value = "" ,required=true )  @Valid @RequestBody OperationDto operationDto) {
     ...
     *         or Not found (status code 404)
     */
    @ApiOperation(value = "Make a payment", nickname = "makePaymentCreditCard", notes = "Make a payment", response = CreditCardDto.class, tags={ "creditCards", })
    @ApiResponses(value = { 
    ...
    Mono<ResponseEntity<CreditCardDto>> makePaymentCreditCard(@ApiParam(value = "ID of the credit card",required=true) @PathVariable("id") String id,@ApiParam(value = "" ,required=true )  @Valid @RequestBody OperationDto operationDto) {
     ...
     *         or Not found (status code 404)
     */
    @ApiOperation(value = "Update a credit card", nickname = "updateCreditCard", notes = "Update a credit card", response = CreditCardDto.class, tags={ "creditCards", })
    @ApiResponses(value = { 
    ...
    Mono<ResponseEntity<CreditCardDto>> updateCreditCard(@ApiParam(value = "" ,required=true )  @Valid @RequestBody CreditCardDto creditCardDto) {
